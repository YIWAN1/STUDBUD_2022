...
class BindObject {
    ...
    set(data) {
        this._set(data);
        if (this._me && this._me.viewRender) this._me.viewRender();
    }
    get() {
        return this._val;
    }
...
const observeRender = (me, containerId, tpl, data)=>{
    ...
    const cc = c.replace("this.value", "__THIS__VALUE").replace(/this\./gi, "window.observeRun(" + me.__objectId + ").").replace("__THIS__VALUE", "this.value");
