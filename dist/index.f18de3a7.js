...
class App {
    ...
    dragUp(e) {
        ...
        if (this.dEle) {
            ...
            this.dEle = null;
            if (inArea) this.setFlowTrackerDone(id);
        }
    }
    dragInArea(e, aimBox) {
        if (!e || !aimBox) return;
