...
class App {
    ...
    onAddSave(formName) {
        ...
        this.hideFloatLayer();
        if (formName == "form1") this.addTask(formData);
        else if (formName == "form2") this.addReading(formData);
        this.data.onlyReset("form1");
        this.data.onlyReset("form2");
        this.viewRender();
    }
...
},{"../js/bind":"e0Agw","juicer":"lkMaW","./app.scss":"kO0m1","./views/footer/footer":"gue9o","../js/kvdb":"815IK","../js/utils":"e8TO1","./app.shtml":"h1n6Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e0Agw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
