(function(win, lib) {
    ...
    if (metaEl) {
        console.warn('The scaling will be set according to the existing meta tags');
    ...
    if (!dpr && !scale) {
        ...
        if (isIPhone) {
            // Under iOS, for screens 2 and 3, use the 2x solution, for the rest use the 1x solution
            if (devicePixelRatio >= 3 && (!dpr || dpr >= 3)) dpr = 3;
            else if (devicePixelRatio >= 2 && (!dpr || dpr >= 2)) dpr = 2;
            else dpr = 1;
        } else // Under other devices, the 1x solution is still used
        dpr = 1;
        scale = 1 / dpr;
    }
...
//# sourceMappingURL=index.5a2809ad.js.map
